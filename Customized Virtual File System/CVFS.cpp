...
void man(char *name)
{
    ...
    {
        printf("Description : Used to write date into regular file\n ");
        printf("Usage : write File_Name\n After this enter the data thatr we want to write\n");
    }
...
int main()
{
    ...
    while(1)
    {
       ...
       if(count == 1)
       {
        ...
        {
            printf("Treminating the Customized Virtual File System\n");
            break;
        }
        else
        {
       ...
       else if (count == 3)
       {
            if(strcmp(command[0],"create")==0)
            {
                ...
                if(ret >= 0)
                    printf("File is successfully created with file descripteor : %d\n",ret);
                if(ret == -1)
                    printf("ERROR : Incorrect parameter\n");
                if(ret == -2)
